...
<html>
  ...
  <body>
    <h1>商品详情</h1>
    <a href="index">首页</a> >> <a href="show">商品列表</a>
    <hr>
    <center>
      <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
          ...
          <td width="70%" valign="top">
             ...
             <div id="cart">
               <a href="cart"><input type="button" value="查看购物车"/></a>
               <a href="buy?sp=add&r1=<%=item.getName() %>&r2=<%=item.getPrice() %>&bm=<%=item.getId() %>"><input type="button" value="加入收藏"></a>        		
               <a href="buy1?sp=add&r1=<%=item.getName() %>&r2=<%=item.getPrice() %>&bm=<%=item.getId() %>"><input type="button" value="加入购物车"></a>        		
           		<input type="button" value="加入购物车"></a>
             </div>
          </td>
          <% 
            }
          ...
          <td width="30%" bgcolor="#EEE" align="center">
             ...
             <dl>
               ...
               <dd class="dd_city">类别:<%=i.getCategoryID() %>&nbsp;&nbsp;价格:<%=i.getPrice() %> ￥ </dd> 
             </dl>
             </div>
             <% 
                   }
