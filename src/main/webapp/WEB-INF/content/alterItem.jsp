...
<h1>商品管理</h1>
<h2>修改商品</h2>
<a href="adminD">删除商品</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="houtai">添加商品</a>
	...
	<table id="tt"  style="width:1200px;height:250px"
		...
		<thead>
			...
			<tr>
				...
				<td  width="80">
				<input class="easyui-textbox" name="newname" style="width:100%;height:35px">
				</td>
				<td  width="80" align="right">
				<input class="easyui-textbox" name="newcategoryID" style="width:100%;height:35px">
				</td>
				<td  width="80" align="right">
				<input class="easyui-textbox" name="newprice" style="width:100%;height:35px">
				</td>
				<td  width="150">
				<input class="easyui-textbox" name="newnumber" style="width:100%;height:35px">
				</td>
				<td  width="60" align="center">
				<input class="easyui-textbox"  name="newpicture" style="width:100%;height:35px">
				</td>
			</tr>
