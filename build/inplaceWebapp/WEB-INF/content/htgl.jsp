...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript" src="js/outlook21.js"> </script>
    <script type="text/javascript">
	 ...
	 var _menus = {
		                 "menus":[
							      ...
							      "menus":[
									{"menuid":"12","menuname":"管理员登录","icon":"icon-page","url":"adminlogin"},
									{"menuid":"13","menuname":"商品添加","icon":"icon-class","url":"houtai"},
									{"menuid":"14","menuname":"商品修改","icon":"icon-role","url":"alterItem"},
									{"menuid":"15","menuname":"商品删除","icon":"icon-set","url":"adminD"},
...
<div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
    ...
    <div title="欢迎使用" style="padding:20px;overflow:hidden; color:red; " >
          <h1 style="font-size:24px;">欢迎使用Bonfire管理系统</h1>
        </div>
  </div>
    </div>
